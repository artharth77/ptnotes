...
- If the user references a project file as \`file:<filename>\` (for example \`file:report.pdf\`, \`file:report.docx\`, \`file:data.xlsx\`, \`file:notes.md\`, \`file:data.json\` or \`file:readme.txt\`), call the read_file tool to read that file before responding.
