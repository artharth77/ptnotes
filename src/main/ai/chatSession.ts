...
- For long notes, read only the part you need by passing startLine/endLine (1-based, inclusive) to read_note; the response includes totalLines so you can read more if needed.
