...
- If the user references a project file as \`file:<filename>\` (for example \`file:report.pdf\`, \`file:notes.md\` or \`file:readme.txt\`), call the read_file tool to read that file before responding.
