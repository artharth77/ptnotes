  ...
  },
  {
    definition: {
      ...
      function: {
        name: 'read_file',
        description:
          'Read the text content of a project file (PDF, markdown or plain text; files live in the project files folder, referenced as `file:<name>`). Extracts the text locally and returns it, so the user does not need to drag and drop the file again.',
        parameters: {
          type: 'object',
          properties: {
            project: {
            ...
            name: {
              type: 'string',
              description: 'Name of the file, e.g. report.pdf, notes.md or readme.txt'
            }
          },
          required: ['name']
        }
