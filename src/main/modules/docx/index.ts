...
const DESIGN_SCHEMA = `{
  ...
  "blocks": [
    ...
    { "type": "table", "title": "Optional caption", "headers": ["A","B"], "rows": [["1","2"]], "widths": [30, 70] (optional, percentage per column, equal if omitted), "width": 100 (optional, table width percent 10-100, default 100) },
