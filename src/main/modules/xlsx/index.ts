  ...
  "sheets": [
    {
      ...
      "rows": [ { "startCell": "A5", "values": ["EMEA", 100, "=B5*2"], "styleRef": "rowA" } ],
      "columns": [22, 14],
...
(STYLE = ${STYLE_SCHEMA}
 ...
 rows entries accept an optional "styleRef" (or inline "style") applied to every cell of that row — use it to clone a template's data-row look across any number of rows; alternate two styleRefs row by row for banded striping.
